...
FinanceEngine emits each claim as a verbatim sentence extracted from one source
...
from finance_engine.index.bm25 import tokenize
from finance_engine.models import ClaimVerdict, Passage
