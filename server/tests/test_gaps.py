...
from finance_engine.gaps import DEFAULT_MIN_DISTINCT, corpus_gap_report, main
...
def test_missing_snapshot_explains_itself_instead_of_a_traceback(tmp_path, capsys):
    ...
    assert "finance_engine.corpus.refresh" in capsys.readouterr().err  # says what to run
